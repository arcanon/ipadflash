...
GLES_CreateRenderer(SDL_Window * window, Uint32 flags)
{
    ...
    fprintf(stderr, "GLES_CreateRenderer\n");

    if (!(window->flags & SDL_WINDOW_OPENGL)) {

        fprintf(stderr, "GLES: SDL_RecreateWindow\n");
        if (SDL_RecreateWindow(window, window->flags | SDL_WINDOW_OPENGL) < 0) {
            fprintf(stderr, "SDL_RecreateWindow failed\n");
            return NULL;
        }
    }
...
GLES_CreateTexture(SDL_Renderer * renderer, SDL_Texture * texture)
{
    ...
    case SDL_PIXELFORMAT_BGR24:
        ...
        fprintf(stderr, "format: SDL_PIXELFORMAT_BGR24\n");
        break;
    case SDL_PIXELFORMAT_ABGR8888:
        internalFormat = GL_RGBA;
        format = GL_RGBA;
        type = GL_UNSIGNED_BYTE;
        fprintf(stderr, "format: SDL_PIXELFORMAT_ABGR8888\n");
        break;
    case SDL_PIXELFORMAT_BGR565:
        internalFormat = GL_RGB;
        format = GL_RGB;
        type = GL_UNSIGNED_SHORT_5_6_5;
        fprintf(stderr, "format: SDL_PIXELFORMAT_BGR565\n");
        break;
    case SDL_PIXELFORMAT_ABGR1555:
        internalFormat = GL_RGBA;
        format = GL_RGBA;
        type = GL_UNSIGNED_SHORT_5_5_5_1;
        fprintf(stderr, "format: SDL_PIXELFORMAT_ABGR1555\n");
        break;
    case SDL_PIXELFORMAT_ABGR4444:
        internalFormat = GL_RGBA;
        format = GL_RGBA;
        type = GL_UNSIGNED_SHORT_4_4_4_4;
        fprintf(stderr, "format: SDL_PIXELFORMAT_ABGR4444\n");
        break;
    default:
        fprintf(stderr,"Unsupported by OpenGL ES texture format %x\n", texture->format);
        return -1;
    }
    ...
    if (result != GL_NO_ERROR) {
        ...
        fprintf(stderr,"glTexImage error\n");
        return -1;
    }
    return 0;
}
...
//    fprintf(stderr, "GLES_RenderCopy\n");
