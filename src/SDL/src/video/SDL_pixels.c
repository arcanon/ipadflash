...
SDL_MapSurface(SDL_Surface * src, SDL_Surface * dst)
{
    ...
    map = src->map;
    fprintf(stderr, "SDL_MapSurface entry\n");
    if ((src->flags & SDL_RLEACCEL) == SDL_RLEACCEL) {
        SDL_UnRLESurface(src, 1);
    }
    fprintf(stderr, "SDL_InvalidateMap entry\n");
    ...
    srcfmt = src->format;
    dstfmt = dst->format;
    fprintf(stderr, "identity entry, bpp %d %d \n", srcfmt->BytesPerPixel,dstfmt->BytesPerPixel);
    ...
    case 1:
        ...
        case 1:
            ...
            fprintf(stderr, "checking pallete entry, %d, %d ident %d \n", srcfmt->palette, dstfmt->palette, map->identity);
            break;
    ...
    fprintf(stderr, "SDL_MapSurface exit ident %d\n", map->identity );
