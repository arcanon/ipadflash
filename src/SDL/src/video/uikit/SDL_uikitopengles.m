...
void UIKit_GL_SwapWindow(_THIS, SDL_Window * window)
{
	...
	if (nil == data->view) {
        fprintf(stderr, "UIKit_GL_SwapWindow swapping with no view");
		return;
	}
   ...
   //fprintf(stderr, "window now visible\n");
...
//	SDL_SetKeyboardFocus(window);
    ...
    fprintf(stderr, "UIKit_GL_CreateContext + view context creation succeeded"); 
